        ...
        <form action="{{ route('libros.store') }}" method="POST"
            ...
            <div>
                ...
                <textarea name="sinopsis" rows="4"
                          class="w-full rounded border border-gray-300 dark:border-slate-600 bg-white dark:bg-slate-900 px-3 py-2">{{ old('sinopsis') }}</textarea>
            </div>
            ...
            <div>
                ...
                <textarea name="sinopsis_en" rows="4"
                          class="w-full rounded border border-gray-300 dark:border-slate-600 bg-white dark:bg-slate-900 px-3 py-2">{{ old('sinopsis_en') }}</textarea>
            </div>
