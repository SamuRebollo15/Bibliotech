...
<head>
    <meta charset="UTF-8">
    <title>Editar perfil | Bibliotech</title>
    <script src="https://cdn.tailwindcss.com"></script>
</head>

<body class="bg-[#e6f0f4] text-gray-800 font-sans">
    <div class="max-w-2xl mx-auto px-4 py-10">
        <h1 class="text-3xl font-bold text-center text-[#1e3a8a] mb-8">✏️ Editar perfil</h1>
        ...
        <form method="POST" action="{{ route('profile.update') }}">
            ...
            <div class="mb-6">
                ...
                <p class="text-sm text-gray-500 mt-1">Déjalo en blanco si no deseas cambiarla.</p>
            </div>

            <div class="flex justify-between">
                <a href="{{ route('cuenta.index') }}" class="bg-gray-600 text-white px-4 py-2 rounded hover:bg-gray-700 transition">Volver</a>
